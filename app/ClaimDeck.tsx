            ...
            {stacks.map((s, i) => (
              ...
              >
                ...
                {s.representative.precio !== null && (
                  <span className="pointer-events-none absolute bottom-1 left-1/2 -translate-x-1/2 rounded-full bg-red-600 px-2 py-0.5 text-[11px] font-bold leading-none text-white shadow-lg">
